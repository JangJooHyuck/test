...
public class Emailcheck {
    public static void main(String[] args) {
        ...
        while (Id.matches(Idpattern) == false) {
            ...
            System.out.println("아이디는 영어와 숫자로만 생성할 수 있습니다.(최소 1글자 ~ 20글자), (. , _ , + , - 4개의 특수문자는 허용)");
        ...
        // 마스킹관련
        // replaceAll (변환하고자하는대상, 변환할 문자)
        // 문자열 {2} 범위 이상부터는 *로 치환 (ex. 12345 -> 12***)
        ...
        // pw 는 아까 masking 한 maskingpw 로 출력함
